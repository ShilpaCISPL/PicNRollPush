...
import picnroll.shilpa_cispl.com.picnroll.userlistview.ImageAdapter;

/**
 * Created by shilpa-cispl on 23/10/17.
 */

public class FolderImageAdapter {
    public static FolderImageAdapter imageAdapter;
    ...
    private FolderImageAdapter(Context context) {
    ...
    public static FolderImageAdapter getInstance(Context SynchronizedContext) {

        if (imageAdapter == null) {

            imageAdapter = new FolderImageAdapter(SynchronizedContext);
        }
        return imageAdapter;
    }
